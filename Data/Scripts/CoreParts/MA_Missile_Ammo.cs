...
{ // Don't edit above this line
    ...
    {
        //MA_Missile
        private AmmoDef MA_Missile => new AmmoDef  //derecho Stage 1
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 15, // controls how responsive tracking is.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f,
                        Width = 0.1f,
                        Color = Color(red: 1, green: 15, blue: 40f, alpha: 1),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 75,
                        Color = Color(red: 2f, green: 2f, blue: 14f, alpha: 0.1f),
                        Back = false,
                        CustomWidth = 0.5f,
        ...
        //MA_Missile Original Stage 1
        private AmmoDef MA_Missile_Stage2 => new AmmoDef  //derecho launch stage 1
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "disabled_MA_Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 500f, //500 Direct damage; one steel plate is worth 100.
